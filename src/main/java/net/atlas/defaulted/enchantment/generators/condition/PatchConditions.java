...
public class PatchConditions {
    ...
    public static void bootstrap() {
        ...
        CONDITION_MAPPER.put(Identifier.withDefaultNamespace("is_enchantment"), EnchantmentIsCondition.CODEC);
        CONDITION_MAPPER.put(Identifier.withDefaultNamespace("in_tag"), EnchantmentHasTagCondition.CODEC);
