...
public class FabricUtils {
    ...
    //? >=1.21.11 {
    /*public static void registerReloadListener(ResourceLocation id, Function<HolderLookup.Provider, PreparableReloadListener> factory) {
    *///?} <1.21.11 {
    public static void registerReloadListener(ResourceLocation id, Function<HolderLookup.Provider, IdentifiableResourceReloadListener> factory) {
    //?}
        //? >=1.21.11 {
