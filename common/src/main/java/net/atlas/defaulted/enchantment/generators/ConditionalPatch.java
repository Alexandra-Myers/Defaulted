...
public record ConditionalPatch(PatchConditions.PatchCondition condition, List<EnchantmentPatchGenerator> generators, EnchantmentOverrides overrides) implements EnchantmentPatchGenerator {
